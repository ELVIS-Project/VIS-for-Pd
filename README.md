...
- Thomas Grill's [py/pyext](http://grrrr.org/research/software/py/). Follow the instructions on Grill's [py/pyext – Python scripting objects for Pure Data and Max](http://grrrr.org/research/software/py/) page, including where to add the resulting binary into the Pd environment later. As a courtesy the py external binaries for Pd (Windows, Linux, and OSX) have bin included in the /lib/pre-compiled-externals folder. Use at your own risk, they may or may not work. 
